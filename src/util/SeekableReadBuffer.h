...
public:
    ...
    virtual std::string getInfoForLog() { return ""; }
    ...
    virtual size_t getFileOffsetOfBufferEnd() const { throw std::runtime_error("Method getFileOffsetOfBufferEnd() not implemented"); }
    ...
    { throw std::runtime_error("Method readBigAt() not implemented"); }
