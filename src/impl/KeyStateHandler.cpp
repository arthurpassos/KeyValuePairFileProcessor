...
KeyStateHandler::KeyStateHandler(char key_value_delimiter, char escape_character,
                                 std::optional<char> enclosing_character)
    : StateHandler(escape_character, enclosing_character), key_value_delimiter(key_value_delimiter)
{}
